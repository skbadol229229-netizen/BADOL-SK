  ...
  return (
    <section className="my-10 md:my-16 overflow-hidden rounded-3xl border border-amber-500/30 bg-gradient-to-br from-[#123019] via-[#0B2E13] to-[#051A0A] p-5 sm:p-8 text-white shadow-2xl relative">
      ...
      {flashProducts.length > 0 && (
        <div className="relative z-10 mt-8 grid grid-cols-2 gap-3.5 sm:gap-6 lg:grid-cols-4">
          {flashProducts.map((product) => (
            <div key={product.id} className="relative h-full">
              <div className="absolute top-3 left-3 z-20 rounded-full bg-red-600 px-2.5 py-0.5 text-[10px] font-extrabold text-white uppercase tracking-wider flex items-center gap-1 shadow-md pointer-events-none">
