...
('vegetables', 'Vegetables (শাক-সবজি)', 'vegetables', 'Farm-fresh pesticide-free organic vegetables sourced directly from native Bangladeshi farmers.', 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=800&q=80', 1, 1),
('fruits', 'Fruits (ফলমূল)', 'fruits', 'Naturally ripened chemical-free seasonal fruits harvested at peak sweetness.', 'https://images.unsplash.com/photo-1619566636858-adf3ef46400b?auto=format&fit=crop&w=800&q=80', 1, 2),
('leafy-greens', 'Leafy Greens (সবুজ শাক)', 'leafy-greens', 'Freshly harvested organic palong shak, lal shak, and nutrient-dense greens.', 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=800&q=80', 1, 3),
('pure-honey', 'Pure Honey (খাঁটি মধু)', 'pure-honey', '100% unpasteurized raw honey collected straight from Sundarban mangrove and wildflower orchards.', 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=800&q=80', 1, 4),
('seeds-and-nuts', 'Seeds & Nuts (বীজ ও বাদাম)', 'seeds-and-nuts', 'Nutrient-dense black seed (Kalojira), organic chia seeds, raw almond, and energy nuts.', 'https://images.unsplash.com/photo-1514733670139-4d87a1941d55?auto=format&fit=crop&w=800&q=80', 1, 5),
('organic-spices', 'Organic Spices (বিশুদ্ধ মশলা)', 'organic-spices', 'Chemical-free, stone-ground turmeric, red chili, cumin, coriander, and whole aromatic spices.', 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=800&q=80', 1, 6),
('oils-and-ghee', 'Oils & Ghee (তেল ও ঘি)', 'oils-and-ghee', 'Traditional wood-pressed mustard oil, pure Pabna cow ghee, and cold-pressed coconut oil.', 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=800&q=80', 1, 7);
...
('p-tomatoes', 'Organic Tomatoes (Deshi) / দেশি টমেটো', 'organic-tomatoes-deshi', 'Freshly plucked farm-fresh organic red tomatoes grown without synthetic fertilizer.', 'Rich in lycopene and natural sweetness. Farm Sourced from Bogura organic gardens.', 'vegetables', '["https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=800&q=80"]', 70, 60, '["500g","1kg","2kg"]', '[{"name":"Farm Red","hex":"#e53935"}]', 100, 'VEG-TOM-01', 1, 1, 1, 1, 1, CURRENT_TIMESTAMP),
('p-spinach', 'Organic Spinach (Palong Shak) / পালং শাক', 'organic-spinach-palong-shak', 'Tender, pesticide-free fresh palong shak harvested every morning.', 'Packed with iron, folate, and essential vitamins. Cleaned and root-trimmed.', 'leafy-greens', '["https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=800&q=80"]', 55, 45, '["250g","500g"]', '[{"name":"Organic Green","hex":"#43a047"}]', 80, 'GRN-SPN-02', 1, 1, 1, 1, 2, CURRENT_TIMESTAMP),
('p-cucumber', 'Organic Cucumber (Shosha) / দেশি শসা', 'organic-cucumber-shosha', 'Crisp, hydrating chemical-free organic green cucumbers.', 'Cool and refreshing. Sourced from agro-ecological farms in Jashore.', 'vegetables', '["https://images.unsplash.com/photo-1604977042946-1eecc30f269e?auto=format&fit=crop&w=800&q=80"]', 85, 70, '["1kg","2kg"]', '[{"name":"Crisp Green","hex":"#2e7d32"}]', 90, 'VEG-CUC-03', 1, 1, 0, 1, 3, CURRENT_TIMESTAMP),
('p-banana', 'Organic Banana (Deshi Sagor) / দেশি সাগর কলা', 'organic-banana-deshi', 'Naturally tree-ripened organic bananas without calcium carbide chemicals.', 'Sweet, high in potassium, naturally ripened in traditional hay stacks.', 'fruits', '["https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?auto=format&fit=crop&w=800&q=80"]', 95, 80, '["1 Dozen","2 Dozen"]', '[{"name":"Golden Yellow","hex":"#fbc02d"}]', 75, 'FRT-BAN-04', 1, 1, 0, 1, 4, CURRENT_TIMESTAMP),
('p1', 'Sundarban Raw Wild Flower Honey (500g)', 'sundarban-raw-wild-honey', '100% pure unheated raw wild flower honey from the Sundarban mangrove forest.', 'Harvested sustainably by traditional honey collectors. Unfiltered, rich in natural enzymes, antioxidants, and wildflower pollen.', 'pure-honey', '["https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=800&q=80"]', 750, 680, '["250g","500g","1kg"]', '[{"name":"Amber Gold","hex":"#f57f17"}]', 50, 'HNY-SND-01', 1, 1, 0, 1, 5, CURRENT_TIMESTAMP),
('p16', 'Wood-Pressed Cold Mustard Oil / কাঠের ঘানি সরিষার তেল (1L)', 'wood-pressed-mustard-oil', 'Traditional Kather Ghani wood-pressed pungent virgin mustard oil.', 'Cold extracted without heat or chemical solvents. Retains full natural aroma, pungency, and vital nutrients.', 'oils-and-ghee', '["https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=800&q=80"]', 380, 340, '["500ml","1 Litre","2 Litres"]', '[{"name":"Golden Yellow","hex":"#fbc02d"}]', 60, 'OIL-MST-16', 1, 1, 0, 1, 6, CURRENT_TIMESTAMP);
